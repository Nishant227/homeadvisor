...
.content {padding:20px;}
 ...
 <div class="header">
<ul>
  <li><a href="http://localhost/php/HomeAdvisor/home.php"><img src="image/logo/homelogo.jpg" width="200" height="50"  ></a></li>
  ...
  <div class="dropdown-content">
    ...
    <a href="http://localhost/php/homeadvisor/categories.php">See All Categories</a>
    <hr>
    <h4>See your price.</h4>
    <h4>Book a time.</h4>
    <h4>Pay Online.</h4>
    <a href="http://localhost/php/HomeAdvisor/services.php" style="background-color:#FF4500">Book Now</a>
    <br>
  ...
  <li><a href="http://localhost/php/HomeAdvisor/signuppro.php">Join Pro Network</a></li>

  <li id="log"  onclick="fun()"><a href="http://localhost/php/HomeAdvisor/login.php">Login</a></li>
<script>
  function fun(){
    document.getElementByid("log").innerHTml="id";
  }
</script>
  <li><form class="example" action="home.php" style="margin:auto;max-width:250px">
